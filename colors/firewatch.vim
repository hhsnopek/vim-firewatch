...
" html
exe "hi! htmlString"   .s:bg_none .s:fg_orange_2
exe "hi! htmlTag"      .s:bg_none .s:fg_blue
exe "hi! htmlLink"     .s:bg_none .s:fg_syntax_fg
...
exe "hi! mkdUrl"     .s:bg_none .s:fg_orange_1 .s:underline
exe "hi! mkdLink"    .s:bg_none .s:fg_orange_2
